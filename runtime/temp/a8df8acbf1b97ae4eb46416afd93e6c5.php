<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\wamp\www\Blogs\public/../application/admin\view\index\bar.html";i:1514445087;}*/ ?>
...
function toggleMenu()
{
  ...
  {
    frmBody.cols="200, 10, *";
    imgArrow.src = "_IMG_/arrow_left.gif";
  }
  else
  {
    frmBody.cols="0, 10, *";
    imgArrow.src = "_IMG_/arrow_right.gif";
  }
}
...
<table height="100%" cellspacing="0" cellpadding="0" id="tbl">
  <tbody><tr><td><a href="javascript:toggleMenu();"><img src="_IMG_/arrow_left.gif" width="10" height="30" id="img" border="0"></a></td></tr>
</tbody></table>
