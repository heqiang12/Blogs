<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp\www\Blogs\public/../application/admin\view\admin\editxx.html";i:1514444847;}*/ ?>
...
//            新密码
            $("#admin_xpwd").blur(function(){
                if($("#admin_xpwd").val().match(/^[0-9]+$/)){
                    $(".span-xpwd").html("密码强度：弱").css("color","#FF8000");
                }
                else if($("#admin_xpwd").val().match(/^[a-zA-Z]+$/)){
                    $(".span-xpwd").html("密码强度：弱").css("color","#FF8000");
                }
                else if($("#admin_xpwd").val().match(/^[a-zA-Z0-9]+$/)){
                    $(".span-xpwd").html("密码强度：中等").css("color","#A5DF00");
                }
                else if($("#admin_xpwd").val().match(/^[a-zA-Z0-9_!@#$%]+$/)){
                    $(".span-xpwd").html("密码强度：强").css("color","green");
                }
            });
            $(".span-phone").hide();
...
<div class="wrap">
    <div class="page-title">
        <span class="modular fl"><i class="add_user"></i><em>个人信息</em></span>
    </div>
    <form id="myform">
        <table class="list-style">
            <tr>
                <td style="width:15%;text-align:right;">管理员昵称：</td>
                <td><input type="text" class="textBox length-middle" name="admin_name" id="admin_name" value="<?php echo $info['admin_name']; ?>"/><span class="span-name" style="display:inline-block;text-indent:1em">  昵称应为2-8位数字，字母，下划线，中文</span></td>
            </tr>
            <tr>
                <td style="text-align:right;">管理员邮箱：</td>
                <td><input type="text" class="textBox length-middle" name="admin_email" id="admin_email" value="<?php echo $info['admin_email']; ?>"/><span class="span-email">email格式不正确！</span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="password" class="textBox length-middle" name="admin_xpwd" id="admin_xpwd" /><span class="span-xpwd" style="display:inline-block;text-indent:1em">使用数字，字母，特殊字符组合安全性更高哦！</span></td>
            </tr>
            <tr>
                <td style="text-align:right;">手机号码：</td>
                <td ><input type="text" class="textBox length-middle" name="admin_phone"
                            id="admin_phone" value="<?php echo $info['admin_phone']; ?>"/><span class="span-phone" style="display:inline-block;text-indent:1em">手机号为11位！</span></td>
            </tr>
            <tr>
